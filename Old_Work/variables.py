...
#! ACTIVITY 1 - Create a program that stores someone’s name, age and favourite colour that 
...
#! ACTIVITY 2 - Create a program that stores what you eat today for breakfast, lunch and dinner, print these.
...
#! ACTIVITY 3 - 
#! (1) Create a 9 variables space1, space2… space9 
#! (2) Assign either the value "x", "o", " " to each of these variable 
#! (3) Insert the variables into the board using the {} .format() syntax
...
#! ACTIVITY 5 - Create a program that calculate the number of days from today to your birth date,
#! and print this out.
