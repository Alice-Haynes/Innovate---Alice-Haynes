...
countries["country_1"].update({"language":"English"})
countries["country_2"].update({"language":"French"})
countries["country_3"].update({"language":"German"})
countries["country_4"].update({"language":"Spanish"})
countries["country_5"].update({"language":"Italian"})
countries["country_6"].update({"language":"Portuguese"})
countries["country_7"].update({"language":"Greek"})
